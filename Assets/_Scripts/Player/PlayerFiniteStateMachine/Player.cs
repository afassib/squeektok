...
public class Player : MonoBehaviour
{
    ...
    public BoxCollider2D collider2D_;
    ...
    private void Awake()
    {
        ...
        if (collider2D_ == null) collider2D_ = GetComponent<BoxCollider2D>();

        //Set movement variable
        if(movement==null) movement = transform.GetChild(0)?.GetChild(0)?.GetComponent<Movement>();
    }
